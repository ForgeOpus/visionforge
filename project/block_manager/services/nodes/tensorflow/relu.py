"""TensorFlow ReLU Activation Node Definition"""
...
class ReLUNode(NodeDefinition):
    ...
    def config_schema(self) -> List[ConfigField]:
        return []  # ReLU has no configurable parameters in TensorFlow
    ...
    def get_tensorflow_code_spec(
        ...
        """Generate TensorFlow code specification for ReLU layer"""
