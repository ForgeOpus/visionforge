"""TensorFlow Custom Layer Node Definition"""
...
class CustomNode(NodeDefinition):
    ...
    def metadata(self) -> NodeMetadata:
        return NodeMetadata(
            ...
            color="#6b7280",
            icon="Code",
            description="User-defined custom layer with arbitrary TensorFlow/Keras code",
    ...
    def config_schema(self) -> List[ConfigField]:
        return [
            ...
            ConfigField(
                ...
                type="textarea",
                required=True,
                description="TensorFlow/Keras layer implementation code"
            ),
            ConfigField(
                name="output_shape",
                label="Output Shape",
