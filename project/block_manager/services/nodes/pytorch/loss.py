...
class LossNode(NodeDefinition):
    ...
    def config_schema(self) -> List[ConfigField]:
        return [
            ...
            ConfigField(
                ...
                description="Optional class weights as JSON array (for classification losses)"
            )
        ]
    ...
    def validate_incoming_connection(
        ...
        # Loss node accepts any input shape (predictions and labels are handled in training script)
        return None
