...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-oy%j%4%)w%7#sx@e!h+m-hai9zvl*)-5$5uz%wlro4ry1*4vc-')
...
# In production, CORS not needed since frontend served by Django
if DEBUG:
    ...
    # In production, same-origin policy applies
