                ...
                <Button variant="outline" size="icon" className="rounded-full">
                  {user?.avatar_url ? (
                    <img
                      ...
                      onError={(e) => {
                        // Fallback to User icon if image fails to load (e.g., 429 rate limit)
                        e.currentTarget.style.display = 'none';
                        e.currentTarget.parentElement!.innerHTML = '<svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor"><path d="M230.92 212c-15.23-26.33-38.7-45.21-66.09-54.16a72 72 0 1 0-73.66 0c-27.39 8.94-50.86 27.82-66.09 54.16a8 8 0 1 0 13.85 8c18.84-32.56 52.14-52 89.07-52s70.23 19.44 89.07 52a8 8 0 1 0 13.85-8ZM72 96a56 56 0 1 1 56 56a56.06 56.06 0 0 1-56-56Z"></path></svg>';
                      }}
                    />
                  ) : (
                    <User size={20} />
