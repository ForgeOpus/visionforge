...
export function HistoryToolbar() {
  ...
  return (
    <div className="fixed top-32 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-2">
      <TooltipProvider>
        <Tooltip>
