 ...
 */
export enum NodeValidationState {
  /** Node not configured */
...
export type AxisRole =
  ...
  | 'time'       // T - sequence/time dimension
  | 'channels'   // C - channel dimension
  | 'height'     // H - spatial height
  | 'width'      // W - spatial width
  | 'features'   // F - feature dimension
  | 'vocab'      // V - vocabulary size
  | 'embedding'  // D - embedding dimension
  | 'classes'    // K - number of classes
  | 'heads'      // N - attention heads
  | 'any';       // Wildcard for any role
