 ...
 */
export function getStateBadgeInfo(state: NodeValidationState): StateBadgeInfo {
  switch (state) {
 ...
 */
export function formatInferenceTrace(
...
export const ERROR_EXAMPLES: Record<ValidationCode, { message: string; hint: string }> = {
  [ValidationCode.OK]: {
    message: '',
    hint: '',
  },
