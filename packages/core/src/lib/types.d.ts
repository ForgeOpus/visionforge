import type { ShapePattern, ShapeFlags, ShapeProvenance, NodeShapeStatus, DimensionValue } from './validation/types';
export type BlockType = 'input' | 'dataloader' | 'output' | 'loss' | 'empty' | 'linear' | 'conv2d' | 'dropout' | 'batchnorm' | 'relu' | 'flatten' | 'maxpool2d' | 'attention' | 'concat' | 'softmax' | 'add' | 'custom';
