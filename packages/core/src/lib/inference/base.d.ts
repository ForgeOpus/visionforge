 ...
 */
import type { ChatOptions, ChatResponse, ValidationOptions, ValidationResponse, ExportOptions, ExportResponse, NodeDefinitionsResponse } from './types';
/**
 ...
 */
export declare abstract class BaseInferenceClient {
    /**
     ...
     */
    abstract getNodeDefinitions(framework: 'pytorch' | 'tensorflow'): Promise<NodeDefinitionsResponse>;
}
/**
